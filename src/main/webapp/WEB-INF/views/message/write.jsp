...
<%--&lt;%&ndash;    <c:when test="${from eq 'sent'}">&ndash;%&gt;--%>
<%--&lt;%&ndash;        <button type="button" onclick="location.href='<c:url value="/sentList"/>'">뒤로가기</button>&ndash;%&gt;--%>
<%--&lt;%&ndash;    </c:when>&ndash;%&gt;--%>
<%--&lt;%&ndash;    <c:otherwise>&ndash;%&gt;--%>
<%--&lt;%&ndash;        <button type="button" onclick="location.href='<c:url value="/receiveList"/>'">뒤로가기</button>&ndash;%&gt;--%>
<%--&lt;%&ndash;    </c:otherwise>&ndash;%&gt;--%>
<%--&lt;%&ndash;</c:choose>&ndash;%&gt;--%>
